...
\section*{Abstraction Symbols}
$\rlap{$\supseteq$}$\tiny $a \attrdef $ \normalsize is read as "has the attribute of"\\
$\rlap{$\subseteq$}$\tiny $a \attrdef $ \normalsize is read as "is an attribute of\\
$a \attrdef =$ defines an attribute\\
$\doteq$ defines a canonical attribute\\
...
$a \atop=$ is read as $is$ or $is$ $a$ $defining$ $attribute$ $of$\\
